...
const Home = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#101212] to-[#08201D] w-full h-full ">
     
      <div className="relative h-screen ">
        {/* Image */}
        <div className="bg-gradient-to-b from-[#101212] to-[#08201D] absolute h-full w-full flex overflow-hidden">
        ...
        <div className="lg:flex lg:pt-20 flex-col items-center justify-center relative z-10 px-6 md:max-w-[90vw] mx-auto">
          ...
          <div className=" flex flex-col items-center justify-center pb-8">
            {/* <h1 className="text-[50px] md:text-[80px] text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white font-bold pt-12">
              JOIN THE ROOM
            </h1> */}
          ...
          >
            <div className=" flex flex-col justify-center items-center">
              <label className="text-[30px] mb-10 md:text-[40px] font-bold pt-6">
                Enter Room Code
              </label>
              <input
                type="text"
